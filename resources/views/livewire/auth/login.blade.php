<main>
    <section class="py-24 w-11/12 lg:w-5/12 mx-auto">
        <div class="rounded-[15px] border border-[#DADADA] p-5 lg:p-10">
            <h6 class="text-xl font-bold">Авторизация</h6>

            <form wire:submit='login()' method="POST" class="mt-5">
                ...
                <div class="mt-3">
                    ...
                    <a href="{{ route('password.request') }}" class="text-sm text-right block mt-2">Забыл пароль</a>
                ...
                <div class="flex items-center space-x-5 mt-5">
                    <button type="submit"
                        class="bg-[#C7A771] py-2.5 px-5 text-white transition duration-500 hover:bg-[#A88448] rounded-[6px] text-sm lg:text-[14px] font-bold text-center">Войти
                        в профиль</button>
